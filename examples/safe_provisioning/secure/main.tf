# Create a CyberArk Privilege Cloud safe. Identical to insecure/main.tf — the only
# difference between the two examples is where the Identity service-user
# credential comes from (see provider.tf: this one sources it from CyberArk Conjur).
